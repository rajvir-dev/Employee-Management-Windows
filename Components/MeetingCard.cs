...
namespace EmployeeManagement_Windows.Components
{
    public partial class MeetingCard : UserControl
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                if (_meeting.AssignedEmployees != null && _meeting.AssignedEmployees.Count > 0)
                {
                    foreach (var emp in _meeting.AssignedEmployees)
                    {
                        var av = new EmployeeManagement_Windows.Controls.AvatarCircle
                        {
                            ...
                            Initials = !string.IsNullOrEmpty(emp.FullName) ? emp.FullName.Substring(0, 1).ToUpper() : "U"
                        };
                ...
                else
                {
                    ...
                    var av = new EmployeeManagement_Windows.Controls.AvatarCircle
                    {
                        Size = new Size(28, 28),
                        Margin = new Padding(0, 0, 4, 0),
                        Initials = !string.IsNullOrEmpty(SessionManager.FullName) ? SessionManager.FullName.Substring(0, 1).ToUpper() : "U"
                    };
            ...
            {
                System.Diagnostics.Debug.WriteLine("MeetingCard LoadData error: " + ex.Message);
            }
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error editing meeting: " + ex.Message);
            }
        }
        ...
        private async void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error cancelling meeting: " + ex.Message);
            }
        }
        ...
        private async void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error deleting meeting: " + ex.Message);
            }
        }
    }
}
